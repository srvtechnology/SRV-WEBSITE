...
@section('title')
<title>Admin | Edit Portfolio</title>
@endsection
@section('left_part')
...
<div class="content-page">
    ...
    <div class="content">
        <div class="wraper container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Portfolio Edit </h4>
                ...
                <div class="col-lg-12">
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            ...
                            <div class="row">
                                <form role="form" action="{{route('admin.update.portfolio')}}" id="frm" method="post" enctype="multipart/form-data">
                                    <div class="panel-body  rm04 col-md-6">
                                       ...
                                       <div class="form-group rm50" style="margin-left: 30px !important ">
                                            ...
                                            <input type="text"  class="form-control" id="AboutMe" placeholder="Enter Portfolio Title"  name="title" style="width: 230px" value="{{$portfolio->title}}">
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="form-group rm50" style="margin-left: 30px !important ">
                                            <label for="title">Coding Language</label>
                                            <input type="text"  class="form-control"  placeholder="Enter user name"  name="coding_language" style="width: 220px" value="{{$portfolio->coding_language}}" >
                                        </div>
                                    ...
                                    <div class="form-group" style="margin-left: 30px;">
                                        ...
                                        <div class="uplodimgfilimgs">
                                            <em><img src="{{url('/')}}/storage/app/public/portfolio/{{@$portfolio->image}}" alt="" style="width: 150px !important; height: 150px !important"></em>
                                        </div>
                                    </div>
