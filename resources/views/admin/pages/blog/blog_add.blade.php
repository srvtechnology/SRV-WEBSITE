...
<div class="content-page">
    ...
    <div class="content">
        <div class="wraper container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Blog Add </h4>
                ...
                <div class="col-lg-12">
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            ...
                            <div class="row">
                                <form role="form" action="{{route('admin.insert.blog')}}" id="frm" method="post" enctype="multipart/form-data">
                                    <div class="panel-body  rm04 col-md-6">
                                        ...
                                        <div class="form-group rm50" style="margin-left: 30px !important ">
                                            ...
                                            <input type="text"  class="form-control" id="AboutMe" placeholder="Enter blog name"  name="blog_name" style="width: 230px" >
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="form-group rm50" style="margin-left: 30px !important ">
                                            <label for="title">User name</label>
                                            <input type="text"  class="form-control"  placeholder="Enter user name"  name="user_name" style="width: 220px" >
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="form-group rm50" style="margin-left: 30px !important ">
                                            <label for="title">Title</label>
                                            <input type="text"  class="form-control"  placeholder="Enter title"  name="title" style="width: 220px" >
                                        </div>

                                        <div class="clearfix"></div>
                                         <div class="form-group rm50" style="margin-left: 30px !important ">
                                            <label for="title">Source</label>
                                            <input type="text"  class="form-control"  placeholder="Enter source"  name="source" style="width: 220px" >
                                        </div>

                                        <div class="clearfix"></div>
                                         <div class="form-group rm50" style="margin-left: 30px !important ">
                                            <label for="title">Link</label>
                                            <input type="text"  class="form-control"  placeholder="Enter link"  name="link" style="width: 220px" >
                                        </div>
                                        ...
                                        <div class="form-group rm50" style="margin-left: 30px !important ">
                                           ...
                                           {{--  <textarea name="long_desc"></textarea> --}}
                                                <textarea id="mytextarea1" style="width: 95%;height: 300px" name="long_desc" ></textarea>
                                        </div>
                                        <div class="clearfix"></div>
