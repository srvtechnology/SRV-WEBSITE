...
<div class="content-page">
  ...
  <div class="content">
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-12">
          <h4 class="pull-left page-title">Review Management</h4>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="add-btn "><a href="{{route('admin.review.add.page')}}"><i class="icofont-plus-circle"></i> Add Review</a></div>
                        ...
                        <tr>
                          ...
                          <td class="rm07">
                            ...
                            <ul>
                              ...
                              <li><a href="{{route('admin.review.view',$value->id)}}">View</a></li>
                              <li><a href="{{route('admin.review.edit',$value->id)}}">Edit</a></li>
                              @if($value->status=="A")
                              <li><a onclick="return confirm('Are you sure want to deactive this review?')" href="{{route('admin.review.inactive',$value->id)}}">Deactive</a></li>
                              @else
                              <li><a onclick="return confirm('Are you sure want to active this review?')" href="{{route('admin.review.active',$value->id)}}">Active</a></li>
                              @endif
                              <li><a onclick="return confirm('Are you sure want to delete this review?')" href="{{route('admin.review.delete',$value->id)}}">Delete</a></li>
