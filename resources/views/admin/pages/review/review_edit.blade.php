                ...
                <div class="col-lg-12">
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            ...
                            <div class="row">
                                <form role="form" action="{{route('admin.update.review')}}" id="frm" method="post" enctype="multipart/form-data">
                                    <div class="panel-body  rm04 col-md-6">
                                        ...
                                        <input type="hidden" name="id" value="{{$review->id}}">
                                         ...
                                         <div class="form-group rm50" style="margin-left: 30px !important ">
                                            ...
                                            <input type="number"  class="form-control" id="AboutMe" placeholder="Enter star" value="{{$review->star}}"  name="star" style="width: 230px" >
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="form-group rm50" style="margin-left: 30px !important ">
                                            <label for="title">Client name</label>
                                            <input type="text"  class="form-control"  placeholder="Enter user name " value="{{$review->client_name}}"  name="client_name" style="width: 220px" >
                                        </div>
                                        ...
                                        <div class="form-group rm50" style="margin-left: 30px !important ">
                                           ...
                                           <textarea name="review"  style="width: 452px;
                                            height: 163px;">{{$review->review}}</textarea>
                                        </div>
